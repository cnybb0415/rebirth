  ...
  return (
    <section className="rounded-2xl border border-foreground/10 bg-white p-6 shadow-sm">
      <div className="flex items-center justify-between gap-3">
        <div>
          <h2 className="text-lg font-semibold">EXO 스케줄</h2>
        </div>
        <Link href="/schedule" className="text-sm font-medium text-foreground/70 hover:text-foreground">
          전체 보기
        </Link>
      </div>
